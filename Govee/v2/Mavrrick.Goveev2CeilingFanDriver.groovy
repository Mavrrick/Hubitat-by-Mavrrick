...
def mainLightToggle(on_off) {
    switch(on_off) {
        case "on":
        sendCommand("mainLightToggle", 1 ,"devices.capabilities.toggle");
        break;
        case "off":
        sendCommand("mainLightToggle", 0 ,"devices.capabilities.toggle");
        break;
        default:
            if (debugLog) {log.debug ("mainLightToggle(): Unknown toggle value}")};
        break;
    }
}
...
def fanToggle(on_off) {
    switch(on_off) {
        case "on":
        sendCommand("fanToggle", 1 ,"devices.capabilities.toggle");
        break;
        case "off":
        sendCommand("fanToggle", 0 ,"devices.capabilities.toggle");
        break;
        default:
            if (debugLog) {log.debug ("fanToggle(): Unknown toggle value}")};
        break;
    }
}

def reverseAirflowToggle(on_off) {
    switch(on_off) {
        case "on":
        sendCommand("reverseAirflowToggle", 1 ,"devices.capabilities.toggle");
        break;
        case "off":
        sendCommand("reverseAirflowToggle", 0 ,"devices.capabilities.toggle");
        break;
        default:
...
def setSpeed(fanspeed) {
    if (debugLog) {log.debug "setFanSpeed(): Processing Working Mode command 'setFanSpeed' to ${fanspeed} with value ${getFanLevel[fanspeed]}"}
