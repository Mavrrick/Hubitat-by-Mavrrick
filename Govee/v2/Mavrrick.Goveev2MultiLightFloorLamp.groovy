...
metadata {
	definition(name: "Govee v2 Multi Light Floor Lamp", namespace: "Mavrrick", author: "Mavrrick") {
		capability "Switch"
        capability "Actuator"
        ...
        attribute "pillarLightToggle", "string"
        attribute "baseLightToggle", "string"
...
//            [name: "color ", type: "COLOR_MAP", description: "color to set"]            
        ...
        command "pillarLightToggle", [
            [name: "Toggle", type: "ENUM", constraints: [0:"off", 1:"on"], description: "Turn on/off Pillar Light"],           
           ]
        command "baseLightToggle", [
            [name: "Toggle", type: "ENUM", constraints: [0:"off", 1:"on"], description: "Turn on/off Base Light"],           
           ]
        command "sceneLoad"
...
def pillarLightToggle(on_off) {
    switch(on_off) {
        case "on":
        sendCommand("pillarLightToggle", 1 ,"devices.capabilities.toggle");
        break; 
        case "off":
        sendCommand("pillarLightToggle", 0 ,"devices.capabilities.toggle");
        break;
        default: 
            if (debugLog) {log.debug ("pillarLightToggle(): Unknown toggle value}")}; 
        break;
    }
}

def baseLightToggle(on_off) {
    switch(on_off) {
        case "on":
        sendCommand("baseLightToggle", 1 ,"devices.capabilities.toggle");
        break; 
        case "off":
        sendCommand("baseLightToggle", 0 ,"devices.capabilities.toggle");
        break;
        default: 
            if (debugLog) {log.debug ("baseLightToggle(): Unknown toggle value}")}; 
        break;
    }
}
